...
// Event data for Madrid Flamenco Night
const event = {
  name: "Madrid Flamenco Night",
  location: "Flamenco Theatre Madrid",
...
const EventPage = () => {
  const [messages, setMessages] = useState([
    { id: 1, user: 'Sarah', text: 'Welcome to the live chat!', isUser: false, time: '7:45 PM' },
    { id: 2, user: 'John', text: 'Looking forward to the show!', isUser: false, time: '7:50 PM' }
  ]);
      ...
      <div className="row">
        ...
        <div className="col-lg-8 col-md-12 mb-4">
          <div className="card shadow-lg border-0 rounded">
            <img 
              src={eventImageMadridFlamencoNight} 
              alt={event.name} 
