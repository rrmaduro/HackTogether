  ...
  return (
    <div className="container my-3">
      ...
      <div className="text-center my-4">
        <h1>Lisbon</h1>
        <p className="lead">Lisbon is Portugal's coastal capital city. Known for its cafe culture and soulful Fado music, offering historic architecture and stunning coastal views.</p>
      </div>
